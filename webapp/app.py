...
def _generate_events(end_date):
    "Tạo một dataset các sự kện gồm 30 ngày trước end_date"
    events = pd.concat(
    [
...
app = Flask(__name__)
app.config["events"] = _generate_events(end_date=date(year=2024,month=9,day=5))
